...
export function createPaymentConfig(avmAddress: string): EndpointConfig {
  return {
    /**
     * 🏎️ F1 COLLECT - Basic Pack
     * Mint a Basic F1 Driver NFT card pack (Common / Rare)
     */
    'POST /api/buy-basic-pack': {
      accepts: [
        {
          scheme: 'exact',
          price: '1000000',
      ...
      description: 'F1 Collect Basic Pack - Pay 1 ALGO to mint card',
    },

    /**
     * 🏁 F1 COLLECT - Apex Pack
     * Mint a Premium Apex F1 Driver NFT card pack (Rare / Legendary)
     */
    'POST /api/buy-premium-pack': {
      accepts: [
        {
          scheme: 'exact',
          price: '5000000',
      ...
      description: 'F1 Collect Apex Pack - Pay 5 ALGO to mint premium card',
    },
